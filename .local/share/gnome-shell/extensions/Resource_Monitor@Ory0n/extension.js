...
try {
  ...
  log(
    "[Resource_Monitor] NetworkManager not found (" +
    error +
    '): The "Auto Hide" feature has been disabled'
  );
}
...
const ResourceMonitor = GObject.registerClass(
  class ResourceMonitor extends PanelMenu.Button {
    _init(settings) {
      ...
      this.add_style_class_name("resource-monitor-panel");
    ...
    _createMainGui() {
      ...
      this._diskStatsIcon = new St.Icon({
        gicon: Gio.icon_new_for_string(
          Me.path + "/icons/disk-stats-symbolic.svg"
        ),
        style_class: "system-status-icon",
      });
      ...
      this._diskSpaceIcon = new St.Icon({
        gicon: Gio.icon_new_for_string(
          Me.path + "/icons/disk-space-symbolic.svg"
        ),
        style_class: "system-status-icon",
      });
      ...
      this._cpuValue.add_style_class_name("cpu-value");
      ...
      this._ramValue.add_style_class_name("ram-value");
